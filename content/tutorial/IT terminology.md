...
![](/tutorial/IT terminology_files/Screen Shot 2020-01-04 at 1.44.50 PM.png)
...
* 2. 메모리(RAM)(램) :  CPU에서 직접 접근이 가능, 사용자가 자유롭게 내용을 읽고 쓰고 지울 수 있다. 휘발성 기억장치, 빠름 
...
> 메모리가 하드디스크보다 더빠르게 데이터를 저장하고 가져올수 있다. 



* 3. 스토리지(하드디스크) : HDD,SSD, 비휘발성 기억장치, 용량이 아주 크지만 느림 


> 가격이 저렴하다.

> 용량이 크고 전원이 꺼져도 데이터가 저장된다.
...
* 하드디스크와 시피유 사이에서.. 정보를 전송해주는 컴퓨터 부품이구요
