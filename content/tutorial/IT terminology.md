...
### CPU & 메모리& 스토리지(HDD,SSD)


* 1. CPU : 중앙정보처리장치, 레지스터, 데이터를 연산/처리하는 가장 중요한 부분, 아주 빠름 

* 2. 메모리 : RAM(Random Access Memory),  CPU에서 직접 접근이 가능, 사용자가 자유롭게 내용을 읽고 쓰고 지울 수 있다. 휘발성 기억장치, 빠름 

* 3. 스토리지 : HDD,SSD, 비휘발성 기억장치, 용량이 아주 크지만 느림 
