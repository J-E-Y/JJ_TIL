...
> 자바스크립트의 모든 객체는 자신의 부모 역할을 하는 객체와 연결되어 있다. 이를 통해 자바스크립트에서는 상속 개념을 구현할 수 있다. 이를 `프로토타입 객체`라고 한다.
...
* 5 patterns of Binding 'this'
 ...
 2. Free Function invocation : window

 3. .call or .apply Invocation : 부모 object

 4. Contruction Mode : (new연산자로 생성된 function 영역의 this) 새로 생성된 객체
